      ...
      <article id="skills">
        <div className="skillsWrap">
          <div>
            ...
            <h2>max lvl cooldown :{[...spells[0].cooldown].reverse()[0]}</h2>
          </div>
          ...
          <div>
            ...
            <h2>max lvl cooldown :{[...spells[1].cooldown].reverse()[0]}</h2>
          </div>
          ...
          <div>
            ...
            <h2>max lvl cooldown :{[...spells[2].cooldown].reverse()[0]}</h2>
          </div>
          ...
          <div>
            ...
            <h2>max lvl cooldown :{[...spells[3].cooldown].reverse()[0]}</h2>
